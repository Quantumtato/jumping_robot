...
#define SW_DEADTIME_NS                      575 /*!< Dead-time to be inserted by FW, only if low side signals are enabled */
...
#define PID_TORQUE_KP_DEFAULT               2997
#define PID_TORQUE_KI_DEFAULT               1383
#define PID_TORQUE_KD_DEFAULT               100
#define PID_FLUX_KP_DEFAULT                 2997
#define PID_FLUX_KI_DEFAULT                 1383
...
#define PID_SPEED_KP_DEFAULT                3433/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define DEFAULT_TARGET_SPEED_RPM            5400
...
#define UD_VOLTAGE_THRESHOLD_V              1 /*!< Under-voltage threshold */
...
/******************************   START-UP PARAMETERS   **********************/
/* Encoder alignment */
#define M1_ALIGNMENT_DURATION               1200 /*!< milliseconds */
#define M1_ALIGNMENT_ANGLE_DEG              90 /*!< degrees [0...359] */
/* Keep FINAL_I_ALIGNMENT_A strictly below IQMAX_A (20 A) so STC_ExecRamp's
 * boundary check (hTargetFinal > MaxPositiveTorque) doesn't reject the ramp. */
#define FINAL_I_ALIGNMENT_A                 18 /*!< s16A */
