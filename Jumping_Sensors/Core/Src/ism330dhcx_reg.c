...
int32_t ism330dhcx_block_data_update_set(const stmdev_ctx_t *ctx,
                                         uint8_t val)
{
  ism330dhcx_ctrl3_c_t ctrl3_c = {0};
  int32_t ret = {0};
...
{
  ism330dhcx_ctrl6_c_t ctrl6_c = {0};
  int32_t ret = {0};
...
{
  ism330dhcx_ctrl7_g_t ctrl7_g = {0};
  int32_t ret = {0};
...
int32_t ism330dhcx_xl_flag_data_ready_get(const stmdev_ctx_t *ctx,
                                          uint8_t *val)
{
  ism330dhcx_status_reg_t status_reg = {0};
  int32_t ret = {0};
                                       ...
                                       int8_t *val)
{
  ...
  ret = ism330dhcx_write_reg(ctx, ISM330DHCX_X_OFS_USR, (uint8_t *)val, 1);
                                       ...
                                       int8_t *val)
{
  ...
  ret = ism330dhcx_read_reg(ctx, ISM330DHCX_X_OFS_USR, (uint8_t *)val, 1);
                                       ...
                                       int8_t *val)
{
  ...
  ret = ism330dhcx_write_reg(ctx, ISM330DHCX_Y_OFS_USR, (uint8_t *)val, 1);
                                       ...
                                       int8_t *val)
{
  ...
  ret = ism330dhcx_read_reg(ctx, ISM330DHCX_Y_OFS_USR, (uint8_t *)val, 1);
                                       ...
                                       int8_t *val)
{
  ...
  ret = ism330dhcx_write_reg(ctx, ISM330DHCX_Z_OFS_USR, (uint8_t *)val, 1);
                                       ...
                                       int8_t *val)
{
  ...
  ret = ism330dhcx_read_reg(ctx, ISM330DHCX_Z_OFS_USR, (uint8_t *)val, 1);
...
{
  ism330dhcx_ctrl10_c_t ctrl10_c = {0};
  int32_t ret = {0};
...
{
  ism330dhcx_ctrl5_c_t ctrl5_c = {0};
  int32_t ret = {0};
...
int32_t ism330dhcx_fifo_out_raw_get(const stmdev_ctx_t *ctx, uint8_t *val)
{
  ...
  ret = ism330dhcx_read_reg(ctx, ISM330DHCX_FIFO_DATA_OUT_X_L, val, 6);
...
{
  ism330dhcx_emb_func_src_t emb_func_src = {0};
  int32_t ret = {0};
...
{
  ism330dhcx_ctrl9_xl_t ctrl9_xl = {0};
  int32_t ret = {0};
...
{
  ism330dhcx_internal_freq_fine_t internal_freq_fine = {0};
  int32_t ret = {0};
...
{
  ism330dhcx_func_cfg_access_t func_cfg_access = {0};
  int32_t ret = {0};
                               ...
                               uint8_t *buf, uint8_t len)
{
  ...
  ism330dhcx_page_sel_t page_sel = {0};
  ism330dhcx_page_address_t page_address = {0};
  uint8_t msb = {0};
  uint8_t lsb = {0};
  int32_t ret = {0};
  uint8_t i = {0};
...
{
  ism330dhcx_counter_bdr_reg1_t counter_bdr_reg1 = {0};
  int32_t ret = {0};
...
int32_t ism330dhcx_device_id_get(const stmdev_ctx_t *ctx, uint8_t *val)
{
  ...
  ret = ism330dhcx_read_reg(ctx, ISM330DHCX_WHO_AM_I, val, 1);
...
{
  ism330dhcx_ctrl4_c_t ctrl4_c = {0};
  int32_t ret = {0};
...
{
  ism330dhcx_ctrl8_xl_t ctrl8_xl = {0};
  int32_t ret = {0};
                                         ...
                                         ism330dhcx_hp_slope_xl_en_t *val)
{
  ...
  else
  {
    ...
    {
      case 0x00:
        *val = is_low_pass == 1u ? ISM330DHCX_LP_ODR_DIV_4 : ISM330DHCX_SLOPE_ODR_DIV_4;
        break;

      case 0x01:
        *val = is_low_pass == 1u ? ISM330DHCX_LP_ODR_DIV_10 : ISM330DHCX_HP_ODR_DIV_10;
        break;

      case 0x02:
        *val = is_low_pass == 1u ? ISM330DHCX_LP_ODR_DIV_20 : ISM330DHCX_HP_ODR_DIV_20;
        break;

      case 0x03:
        *val = is_low_pass == 1u ? ISM330DHCX_LP_ODR_DIV_45 : ISM330DHCX_HP_ODR_DIV_45;
        break;

      case 0x04:
        *val = is_low_pass == 1u ? ISM330DHCX_LP_ODR_DIV_100 : ISM330DHCX_HP_ODR_DIV_100;
        break;

      case 0x05:
        *val = is_low_pass == 1u ? ISM330DHCX_LP_ODR_DIV_200 : ISM330DHCX_HP_ODR_DIV_200;
        break;

      case 0x06:
        *val = is_low_pass == 1u ? ISM330DHCX_LP_ODR_DIV_400 : ISM330DHCX_HP_ODR_DIV_400;
        break;
...
{
  ism330dhcx_tap_cfg0_t tap_cfg0 = {0};
  int32_t ret = {0};
...
{
  ism330dhcx_pin_ctrl_t pin_ctrl = {0};
  int32_t ret = {0};
  ...
  if (ret == 0)
  {
    pin_ctrl.ois_pu_dis = (uint8_t)val & 0x01U;
                                      ...
                                      ism330dhcx_ois_on_t val)
{
  ...
  if (ret == 0)
  {
    ctrl7_g.ois_on_en = ((uint8_t)val >> 1) & 0x01U;
...
int32_t ism330dhcx_aux_xl_flag_data_ready_get(const stmdev_ctx_t *ctx,
                                              uint8_t *val)
{
  ism330dhcx_status_spiaux_t status_spiaux = {0};
  int32_t ret = {0};
...
{
  ism330dhcx_int_ois_t int_ois = {0};
  int32_t ret = {0};
  ...
  if (ret == 0)
  {
    int_ois.st_xl_ois = (uint8_t)val & 0x03U;
                                        ...
                                        ism330dhcx_den_lh_ois_t val)
{
  ...
  if (ret == 0)
  {
    int_ois.den_lh_ois = (uint8_t)val & 0x01U;
    ret = ism330dhcx_write_reg(ctx, ISM330DHCX_INT_OIS,
                               (uint8_t *)&int_ois, 1);
  }
...
{
  ism330dhcx_int_ois_t int_ois = {0};
  ism330dhcx_ctrl1_ois_t ctrl1_ois = {0};
  int32_t ret = {0};
  ...
  if (ret == 0)
  {
    ctrl1_ois.lvl1_ois = ((uint8_t)val  >> 1) & 0x01U;
                                        ...
                                        uint8_t val)
{
  ...
  if (ret == 0)
  {
    int_ois.int2_drdy_ois = (uint8_t)val & 0x01U;
    ret = ism330dhcx_write_reg(ctx, ISM330DHCX_INT_OIS,
                               (uint8_t *)&int_ois, 1);
  }
                                ...
                                ism330dhcx_ois_en_spi2_t val)
{
  ...
  if (ret == 0)
  {
    ...
    ctrl1_ois.mode4_en = ((uint8_t)val >> 1) & 0x01U;
    ret = ism330dhcx_write_reg(ctx, ISM330DHCX_CTRL1_OIS,
                               (uint8_t *)&ctrl1_ois, 1);
  }
                                         ...
                                         ism330dhcx_fs_g_ois_t val)
{
  ...
  if (ret == 0)
  {
    ...
    ctrl1_ois.fs_125_ois = ((uint8_t)val >> 2) & 0x01U;
    ret = ism330dhcx_write_reg(ctx, ISM330DHCX_CTRL1_OIS,
                               (uint8_t *)&ctrl1_ois, 1);
  }
                                    ...
                                    ism330dhcx_sim_ois_t val)
{
  ...
  if (ret == 0)
  {
    ctrl1_ois.sim_ois = (uint8_t)val & 0x01U;
    ret = ism330dhcx_write_reg(ctx, ISM330DHCX_CTRL1_OIS,
                               (uint8_t *)&ctrl1_ois, 1);
  }
...
{
  ism330dhcx_ctrl2_ois_t ctrl2_ois = {0};
  int32_t ret = {0};
                                           ...
                                           ism330dhcx_hpm_ois_t val)
{
  ...
  if (ret == 0)
  {
    ...
    ctrl2_ois.hp_en_ois = ((uint8_t)val >> 4) & 0x01U;
    ret = ism330dhcx_write_reg(ctx, ISM330DHCX_CTRL2_OIS,
                               (uint8_t *)&ctrl2_ois, 1);
  }
...
{
  ism330dhcx_ctrl3_ois_t ctrl3_ois = {0};
  int32_t ret = {0};
  ...
  if (ret == 0)
  {
    ctrl3_ois.st_ois_clampdis = (uint8_t)val & 0x01U;
                                        ...
                                        ism330dhcx_st_ois_t val)
{
  ...
  if (ret == 0)
  {
    ctrl3_ois.st_ois = (uint8_t)val & 0x03U;
    ret = ism330dhcx_write_reg(ctx, ISM330DHCX_CTRL3_OIS,
                               (uint8_t *)&ctrl3_ois, 1);
  }
                                        ...
                                        ism330dhcx_filter_xl_conf_ois_t val)
{
  ...
  if (ret == 0)
  {
    ctrl3_ois.filter_xl_conf_ois = (uint8_t)val & 0x07U;
    ret = ism330dhcx_write_reg(ctx, ISM330DHCX_CTRL3_OIS,
                               (uint8_t *)&ctrl3_ois, 1);
  }
                                         ...
                                         ism330dhcx_fs_xl_ois_t val)
{
  ...
  if (ret == 0)
  {
    ctrl3_ois.fs_xl_ois = (uint8_t)val & 0x03U;
    ret = ism330dhcx_write_reg(ctx, ISM330DHCX_CTRL3_OIS,
                               (uint8_t *)&ctrl3_ois, 1);
  }
...
{
  ism330dhcx_tap_cfg2_t tap_cfg2 = {0};
  int32_t ret = {0};
...
{
  ism330dhcx_wake_up_dur_t wake_up_dur = {0};
  int32_t ret = {0};
...
{
  ism330dhcx_wake_up_ths_t wake_up_ths = {0};
  int32_t ret = {0};
                                ...
                                ism330dhcx_inact_en_t val)
{
  ...
  if (ret == 0)
  {
    tap_cfg2.inact_en = (uint8_t)val & 0x03U;
    ret = ism330dhcx_write_reg(ctx, ISM330DHCX_TAP_CFG2,
                               (uint8_t *)&tap_cfg2, 1);
  }
                                          ...
                                          uint8_t val)
{
  ...
  if (ret == 0)
  {
    tap_cfg0.tap_z_en = (uint8_t)val & 0x01U;
    ret = ism330dhcx_write_reg(ctx, ISM330DHCX_TAP_CFG0,
                               (uint8_t *)&tap_cfg0, 1);
  }
...
{
  ism330dhcx_tap_cfg1_t tap_cfg1 = {0};
  int32_t ret = {0};
  ...
  if (ret == 0)
  {
    tap_cfg1.tap_ths_x = (uint8_t)val & 0x01U;
...
int32_t ism330dhcx_tap_threshold_y_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  if (ret == 0)
  {
    tap_cfg2.tap_ths_y = (uint8_t)val & 0x01U;
    ret = ism330dhcx_write_reg(ctx, ISM330DHCX_TAP_CFG2,
                               (uint8_t *)&tap_cfg2, 1);
  }
...
{
  ism330dhcx_tap_ths_6d_t tap_ths_6d = {0};
  int32_t ret = {0};
  ...
  if (ret == 0)
  {
    tap_ths_6d.tap_ths_z = (uint8_t)val & 0x1FU;
...
{
  ism330dhcx_int_dur2_t int_dur2 = {0};
  int32_t ret = {0};
...
{
  ism330dhcx_free_fall_t free_fall = {0};
  int32_t ret = {0};
...
{
  ism330dhcx_fifo_ctrl1_t fifo_ctrl1 = {0};
  ism330dhcx_fifo_ctrl2_t fifo_ctrl2 = {0};
  int32_t ret = {0};
...
int32_t ism330dhcx_compression_algo_init_set(const stmdev_ctx_t *ctx,
                                             uint8_t val)
{
  ism330dhcx_emb_func_init_b_t emb_func_init_b = {0};
  int32_t ret = {0};
  ...
  if (ret == 0)
  {
    emb_func_init_b.fifo_compr_init = (uint8_t)val & 0x01U;
...
{
  ism330dhcx_fifo_ctrl2_t fifo_ctrl2 = {0};
  ism330dhcx_emb_func_en_b_t emb_func_en_b = {0};
  int32_t ret = {0};
  ...
  if (ret == 0)
  {
    emb_func_en_b.fifo_compr_en = ((uint8_t)val >> 2) & 0x01U;
                                                  ...
                                                  uint8_t val)
{
  ...
  if (ret == 0)
  {
    fifo_ctrl2.fifo_compr_rt_en = (uint8_t)val & 0x01U;
    ret = ism330dhcx_write_reg(ctx, ISM330DHCX_FIFO_CTRL2,
                               (uint8_t *)&fifo_ctrl2, 1);
  }
...
{
  ism330dhcx_fifo_ctrl3_t fifo_ctrl3 = {0};
  int32_t ret = {0};
...
{
  ism330dhcx_fifo_ctrl4_t fifo_ctrl4 = {0};
  int32_t ret = {0};
...
int32_t ism330dhcx_batch_counter_threshold_set(const stmdev_ctx_t *ctx,
                                               uint16_t val)
{
  ism330dhcx_counter_bdr_reg2_t counter_bdr_reg1 = {0};
  ism330dhcx_counter_bdr_reg2_t counter_bdr_reg2 = {0};
  int32_t ret = {0};
...
{
  ism330dhcx_fifo_data_out_tag_t fifo_data_out_tag = {0};
  int32_t ret = {0};
...
{
  ism330dhcx_emb_func_fifo_cfg_t emb_func_fifo_cfg = {0};
  int32_t ret = {0};
  ...
  if (ret == 0)
  {
    emb_func_fifo_cfg.pedo_fifo_en = (uint8_t)val & 0x01U;
...
int32_t ism330dhcx_sh_batch_slave_0_set(const stmdev_ctx_t *ctx,
                                        uint8_t val)
{
  ism330dhcx_slv0_config_t slv0_config = {0};
  int32_t ret = {0};
...
int32_t ism330dhcx_sh_batch_slave_1_set(const stmdev_ctx_t *ctx,
                                        uint8_t val)
{
  ism330dhcx_slv1_config_t slv1_config = {0};
  int32_t ret = {0};
...
int32_t ism330dhcx_sh_batch_slave_2_set(const stmdev_ctx_t *ctx,
                                        uint8_t val)
{
  ism330dhcx_slv2_config_t slv2_config = {0};
  int32_t ret = {0};
...
int32_t ism330dhcx_sh_batch_slave_3_set(const stmdev_ctx_t *ctx,
                                        uint8_t val)
{
  ism330dhcx_slv3_config_t slv3_config = {0};
  int32_t ret = {0};
...
{
  ism330dhcx_emb_func_en_a_t emb_func_en_a = {0};
  int32_t ret = {0};
...
int32_t ism330dhcx_pedo_step_detect_get(const stmdev_ctx_t *ctx,
                                        uint8_t *val)
{
  ism330dhcx_emb_func_status_mainpage_t emb_func_status = {0};
  int32_t ret = {0};
...
{
  ism330dhcx_pedo_cmd_reg_t pedo_cmd_reg = {0};
  int32_t ret = {0};
  ...
  if (ret == 0)
  {
    pedo_cmd_reg.carry_count_en = (uint8_t)val & 0x01U;
...
int32_t ism330dhcx_motion_sens_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  if (ret == 0)
  {
    emb_func_en_a.sign_motion_en = (uint8_t)val & 0x01U;
    ret = ism330dhcx_write_reg(ctx, ISM330DHCX_EMB_FUNC_EN_A,
                               (uint8_t *)&emb_func_en_a, 1);
  }
...
int32_t ism330dhcx_motion_flag_data_ready_get(const stmdev_ctx_t *ctx,
                                              uint8_t *val)
{
  ism330dhcx_emb_func_status_t emb_func_status = {0};
  int32_t ret = {0};
...
int32_t ism330dhcx_tilt_sens_set(const stmdev_ctx_t *ctx, uint8_t val)
{
  ...
  if (ret == 0)
  {
    emb_func_en_a.tilt_en = (uint8_t)val & 0x01U;
    ret = ism330dhcx_write_reg(ctx, ISM330DHCX_EMB_FUNC_EN_A,
                               (uint8_t *)&emb_func_en_a, 1);
  }
...
{
  ism330dhcx_mag_cfg_a_t mag_cfg_a = {0};
  int32_t ret = {0};
...
{
  ism330dhcx_mag_cfg_b_t mag_cfg_b = {0};
  int32_t ret = {0};
...
{
  ism330dhcx_fsm_long_counter_clear_t fsm_long_counter_clear = {0};
  int32_t ret = {0};
                               ...
                               uint8_t *val)
{
  ...
  if (ret == 0)
  {
    ret = ism330dhcx_read_reg(ctx, ISM330DHCX_FSM_OUTS1, val, 16);
  }
...
{
  ism330dhcx_emb_func_odr_cfg_b_t emb_func_odr_cfg_b = {0};
  int32_t ret = {0};
                                              ...
                                              uint8_t *val)
{
  ...
  ret = ism330dhcx_ln_pg_write_byte(ctx, ISM330DHCX_FSM_PROGRAMS, val);
                                              ...
                                              uint8_t *val)
{
  ...
  ret = ism330dhcx_ln_pg_read_byte(ctx, ISM330DHCX_FSM_PROGRAMS, val);
...
{
  ism330dhcx_emb_func_en_b_t reg = {0};
  int32_t ret = {0};
...
{
  ism330dhcx_emb_func_odr_cfg_c_t reg = {0};
  int32_t ret = {0};
...
int32_t ism330dhcx_mlc_out_get(const stmdev_ctx_t *ctx, uint8_t *val)
{
  ...
  if (ret == 0)
  {
    ret = ism330dhcx_read_reg(ctx, ISM330DHCX_MLC0_SRC, val, 8);
  }
...
{
  ism330dhcx_slv0_add_t slv0_add = {0};
  int32_t ret = {0};
...
{
  ism330dhcx_slv1_config_t slv1_config = {0};
  ism330dhcx_slv1_add_t slv1_add = {0};
  int32_t ret = {0};
...
{
  ism330dhcx_slv2_config_t slv2_config = {0};
  ism330dhcx_slv2_add_t slv2_add = {0};
  int32_t ret = {0};
...
{
  ism330dhcx_slv3_config_t slv3_config = {0};
  ism330dhcx_slv3_add_t slv3_add = {0};
  int32_t ret = {0};
